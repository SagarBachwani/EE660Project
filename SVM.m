...
model_linear=svmtrain(label_train,train,'-t 0');
[yhat1,acc1,dec1]=svmpredict(label_test,test,model_linear);

model_rbf=svmtrain(label_train,train,'-t 2');
[yhat2,acc2,dec2]=svmpredict(label_test,test,model_rbf);

model_sig=svmtrain(label_train,train,'-t 3');
[yhat3,acc3,dec3]=svmpredict(label_test,test,model_sig);
